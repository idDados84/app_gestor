...
const ContasReceberCRUD: React.FC<ContasReceberCRUDProps> = ({ 
  ...
  const handleInstallmentManagement = async (conta: ContaReceber) => {
    try {
  ...
  const checkForInstallmentReplication = async (originalRecord: ContaReceber, updatedRecord: ContaReceber) => {
    try {
